...
const STATUS_STYLES: Record<STOStatus, string> = {
  ...
  FINANCE_REVIEW:      'bg-purple-100 text-purple-800',
...
export const PRIORITY_LABELS: Record<number, string> = { 1: 'Urgent', 2: 'Expedited', 3: 'Standard' };
...
export function PriorityBadge({ priority }: { priority: number }) {
  return (
    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${PRIORITY_STYLES[priority] || 'bg-gray-100'}`}>
